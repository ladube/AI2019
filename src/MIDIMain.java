...
public class MIDIMain extends PApplet { //also NOTE that I have inherited from the Processing main class.
	...
	public static void main(String[] args) {
		...
		PApplet.main("MIDIMain"); //I've told my parent class (the Processing project/application) that the
